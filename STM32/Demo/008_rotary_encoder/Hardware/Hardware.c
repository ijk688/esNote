...
//初始化旋转编码器A口
void ROTARY_ENCODERA_Init(uint32_t RCC_APB2Periph,GPIO_TypeDef* GPIOx,uint16_t GPIO_Pin){
  //打开时钟
     RCC_APB2PeriphClockCmd(RCC_APB2Periph,ENABLE);
    //初始化GPIO
    GPIO_InitTypeDef GPIO_InitStructure;
...
//初始化旋转编码器B口
void ROTARY_ENCODERAB_Init(uint32_t RCC_APB2Periph,GPIO_TypeDef* GPIOx,uint16_t GPIO_Pin){
  //打开时钟
     RCC_APB2PeriphClockCmd(RCC_APB2Periph,ENABLE);
    //初始化GPIO
    GPIO_InitTypeDef GPIO_InitStructure;
